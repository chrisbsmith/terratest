...
1. Copy all the files from the [basic terraform example](https://github.com/chrisbsmith/terratest/tree/master/examples/terraform-basic-example/) into the `examples` folder.

1. Copy the [basic terraform example test](https://github.com/chrisbsmith/terratest/blob/master/test/terraform_basic_example_test.go) into the `test` folder.
...
The above is just a small taste of what you can do with [Terratest](https://github.com/chrisbsmith/terratest). To 
learn more:
